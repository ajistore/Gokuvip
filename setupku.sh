...
# domain random
CDN="https://raw.githubusercontent.com/arivpnstores/xraylite/main/ssh"
...
wget -q https://raw.githubusercontent.com/ajistore/Gokuvip/main/tools.sh && chmod +x tools.sh && ./tools.sh
rm tools.sh
clear
# izin
MYIP=$(wget -qO- ipinfo.io/ip);
...
CEKEXPIRED () {
        ...
        Exp1=$(curl -sS https://raw.githubusercontent.com/ajistore/permission/main/ip | grep $MYIP | awk '{print $3}')
        if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl -sS https://raw.githubusercontent.com/ajistore/permission/main/ip | awk '{print $4}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
echo "IZIN DI TERIMA!!"
CEKEXPIRED
else
...
sleep 2
clear
wget -q -O ssh-vpn.sh https://raw.githubusercontent.com/ajistore/Gokuvip/main/ajistore/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
sleep 2
clear
wget https://raw.githubusercontent.com/arivpnstores/xraylite/main/nginx-ssl.sh && chmod +x nginx-ssl.sh && ./nginx-ssl.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/ajistore/Gokuvip/main/Insshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh

#exp
cd /usr/bin
wget -O xp "https://raw.githubusercontent.com/arivpnstores/xraylite/main/xp.sh"
chmod +x xp
sleep 1
wget -q -O /usr/bin/notramcpu "https://raw.githubusercontent.com/arivpnstores/xraylite/main/Finaleuy/notramcpu" && chmod +x /usr/bin/notramcpu
...
wget raw.githubusercontent.com/arivpnstores/xraylite/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
cd
cd /usr/local/sbin/
wget raw.githubusercontent.com/arivpnstores/xraylite/main/limit/limit-all-ip 
...
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 2
wget -q -O ins-xray.sh https://raw.githubusercontent.com/arivpnstores/xraylite/main/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
sleep 1
wget -q -O senmenu.sh https://raw.githubusercontent.com/arivpnstores/xraylite/main/senmenu.sh && chmod +x senmenu.sh && ./senmenu.sh
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "$green      Install slowdns              $NC"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 2
wget https://raw.githubusercontent.com/arivpnstores/xraylite/main/slowdns/installsl.sh && chmod +x installsl.sh && ./installsl.sh
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ Script Credit By AJISCTUNNEL ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
echo "ADIOS"

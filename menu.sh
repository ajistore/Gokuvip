...
data_ip="https://raw.githubusercontent.com/ajistore/permission/main/ip"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[0;36mTelegram${NC} GOKUVIP"
    echo -e "      ${GREEN}WhatsApp${NC} wa.me/6283130791995"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit
  fi
}
...
Name=$(curl -sS https://raw.githubusercontent.com/ajistore/permission/main/ip | grep $MYIP | awk '{print $2}')
if [ "$res" = "Expired" ]; then
Exp="\e[36mExpired\033[0m"
else
Exp=$(curl -sS https://raw.githubusercontent.com/ajistore/permission/main/ip | grep $MYIP | awk '{print $3}')
fi
...
export sem=$( curl -s https://raw.githubusercontent.com/ajistore/Gokuvip/main/versions)
...
echo -e "  ${BLUE}• ${GREEN}Developer           ${NC}= Aji VPN Tunneling ${NC}"
echo -e "$COLOR1┌────────────────────────────────────────────────────────────┐${NC}"
...
echo -e "${BICyan}│ ${BOLD}${YELLOW}Developer = ajivip                   ${NC}"
